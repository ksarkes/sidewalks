...
public class SidewalkProcessor {
    ...
    public void addBoundContainer(BoundContainer boundContainer) {
    ...
    public void addWayContainer(WayContainer wayContainer) {
        ways.add(wayContainer);
    }

    public void addRelationContainer(RelationContainer relationContainer) {
